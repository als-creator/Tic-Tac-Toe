...
- **Интерактивный интерфейс:** Плавный эффект подсвечивания (hover) кнопок при наведении мыши и жирные, контрастные шрифты.
...
- **Кроссплатформенность:** Оптимизировано для Linux, Windows и macOS (используются безопасные PNG/ICO-иконки для защиты от падений графического движка Tcl/Tk).
